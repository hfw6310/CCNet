...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/home/hfw/data/Desnowing/CSD')
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='results/CCNet/CSD/model.pkl')
    ...
    args.model_save_dir = os.path.join('results/', 'CCNet', 'CSD/')
